...
#con <- ser("http://ChurnPrediction/churnModel.Rdata")
#con <- ser("churnModel.getdata.Rdata/index.html")
con <- url("http://michaelchen1004.github.io/ChurnPrediction/churnModel.Rdata")
#con <- url("churnModel.Rdata")
load(con)
#load.model("churnModel.Rdata")
...
shinyServer(function(input, output) {
    ...
    # predicting the churn using the RF model for the displayed customer accounts.
    ...
    # display the predicted accounts which have churn probabilities.
